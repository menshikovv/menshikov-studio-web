...
const services = [
  ...
  },
  {
    ...
    price: "от 80 000 ₽",
    priceDetails: "Срок: 14-21 день",
    popular: true,
  },
  {
    icon: Layers,
    title: "Комплексные решения",
    description: "Веб-сайт + Telegram Mini App + CRM система для масштабирования бизнеса",
    features: [
